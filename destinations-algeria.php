                ...
                <div class="col-lg-10">
                    <div class="destination-details-content">
                        ...
                        <ul class="destination-info">
                            ...
                            <li>
                                <div class="content">
                                    <span>Currency -</span> Algerian Dinar (DZD)
                                </div>
                            ...
                            <li>
                                ...
                                <div class="info">
                                    ...
                                    <div class="tooltip-text">French and English are spoken in tourist areas and by guides.</div>
                                </div>
                            </li>
                        </ul>
                        <p>Algeria, the largest country in Africa and the Arab world, is a land of breathtaking contrasts — from the timeless ruins of Roman cities to the endless golden dunes of the Sahara, dramatic Mediterranean coastlines, and vibrant Berber culture. Algiers' historic Casbah, ancient Timgad, the majestic Tassili n'Ajjer rock art, and the vast desert oasis towns offer an authentic North African experience far from the crowds. With rich history spanning Phoenician, Roman, Byzantine, Ottoman, and French influences, Algeria captivates adventurous travelers, history enthusiasts, and those seeking untouched natural beauty and genuine hospitality.</p>
                            ...
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Algiers Casbah</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Sahara Desert – Tassili n'Ajjer</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Timgad Roman Ruins</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Djemila Archaeological Site</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Ghardaïa & M'Zab Valley</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Oran & Mediterranean Coast</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Hoggar Mountains & Ahaggar</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center">
                        ...
                        <p>Because we don’t just plan your trip — we craft unforgettable journeys through the hidden gems of Algeria.</p>
                    </div>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <p>From secret Saharan routes to exclusive access to ancient Roman sites and Berber villages — we curate every journey with insider knowledge from local Algerian guides.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <p>No hidden fees — clear, all-inclusive packages for desert camps, private 4x4 tours, and authentic experiences, tailored to your budget.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <h4>24/7 Support</h4>
                        <p>Round-the-clock assistance from our local team — whether it's last-minute desert permit arrangements, guide changes, or any adventure in the Sahara or historic cities.</p>
                    </div>
                </div>
            </div>
            <ul>
                <li>Personalized Itineraries</li>
                <li>Trusted Local Guides & Partners</li>
                <li>Curated Authentic Experiences</li>
            </ul>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="swiper destionation-dt-customer-gallery-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img1.png" alt="Customer exploring the Casbah of Algiers at sunset">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img2.png" alt="Sunrise over the dunes in Tassili n'Ajjer">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img3.png" alt="Walking through the ancient Roman ruins of Timgad">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img4.png" alt="Desert camp under the stars in the Sahara">
                            </div>
                            <div class="swiper-slide">
                            ...
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img6.png" alt="M'Zab Valley architecture in Ghardaïa">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img7.png" alt="Hiking among prehistoric rock art in Tassili n'Ajjer">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4">
                    ...
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img1.jpg" alt="Spring in Algeria - Blooming landscapes near the coast">
                            </div>
                            <div class="travel-season-content">
                                <h5>Spring (March–May)</h5>
                                <span>Weather: 15–28°C / 59–82°F (mild & pleasant)</span>
                                <div class="highlights-area">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Ideal for exploring Roman ruins & northern cities.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Comfortable temperatures in the Sahara & mountains.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Fewer crowds & perfect for photography.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Most travelers, history lovers, comfortable exploration</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img2.jpg" alt="Summer in Algeria - Mediterranean coast">
                            </div>
                            <div class="travel-season-content">
                                <h5>Summer (June–August)</h5>
                                <span>Weather: 25–45°C+ / 77–113°F+ (very hot, especially desert)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Pleasant coastal weather in Algiers & Oran.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Lowest crowds in southern desert regions.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Early morning visits to archaeological sites.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Budget travelers, coastal escapes, heat-tolerant adventurers</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img3.jpg" alt="Autumn in Algeria - Golden Sahara light">
                            </div>
                            <div class="travel-season-content">
                                <h5>Autumn (September–November)</h5>
                                <span>Weather: 18–32°C / 64–90°F (warm & comfortable)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Excellent for desert expeditions & rock art.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Shoulder season — best deals & fewer tourists.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Perfect light for photography in the desert & ruins.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Photographers, desert adventurers, value seekers</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img4.jpg" alt="Winter in Algeria - Clear skies over Timgad">
                            </div>
                            <div class="travel-season-content">
                                <h5>Winter (December–February)</h5>
                                <span>Weather: 10–22°C / 50–72°F (mild & sunny in north, cool in desert)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Very pleasant for northern sites & Casbah exploration.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Clear skies & perfect conditions for desert & ruins.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Peak season in the north — vibrant & comfortable.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: First-timers, history & archaeology lovers, mild weather</span>
                    </div>
                </div>
            </div>
        </div>
