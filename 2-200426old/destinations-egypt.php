                ...
                <div class="col-lg-10">
                    <div class="destination-details-content">
                        ...
                        <ul class="destination-info">
                            ...
                            <li>
                                <div class="content">
                                    <span>Currency -</span> Egyptian Pound (EGP)
                                </div>
                            ...
                            <li>
                                ...
                                <div class="info">
                                    ...
                                    <div class="tooltip-text">English is widely spoken in tourist areas.</div>
                                </div>
                            </li>
                        </ul>
                        <p>Egypt, known as the <span>"Land of the Pharaohs"</span>, is home to one of the world's oldest civilizations and offers an extraordinary blend of ancient wonders, vibrant culture, and stunning natural beauty. From the iconic Pyramids of Giza to the majestic temples along the Nile, pristine Red Sea beaches, and bustling souks, Egypt captivates travelers with its timeless history, world-class archaeology, and warm hospitality. A cradle of human civilization for over 5,000 years, Egypt remains a bucket-list destination for history lovers, adventure seekers, and those seeking unforgettable experiences.</p>
                            ...
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Pyramids of Giza</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Valley of the Kings</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Luxor Temple</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Abu Simbel Temples</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Nile River Cruise</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Red Sea Resorts</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Aswan & Philae Temple</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center">
                        ...
                        <p>Because we don’t just plan your trip — we craft unforgettable journeys through the Land of the Pharaohs.</p>
                    </div>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <p>From hidden gems in the Nubian villages to exclusive access inside the Great Pyramid — we curate every journey with insider knowledge from local Egyptologists.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <p>No hidden fees — clear, all-inclusive packages for Nile cruises, private guides, and exclusive experiences, tailored to your budget.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <h4>24/7 Support</h4>
                        <p>Round-the-clock assistance from our local team — whether it's last-minute Nile cruise changes, hot air balloon bookings, or any adventure in the desert.</p>
                    </div>
                </div>
            </div>
            <ul>
                <li>Personalized Itineraries</li>
                <li>Trusted Egyptologist Guides & Partners</li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="swiper destionation-dt-customer-gallery-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img1.png" alt="Customer at Pyramids of Giza">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img2.png" alt="Nile cruise sunset experience">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img3.png" alt="Exploring Karnak Temple">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img4.png" alt="Hot air balloon over Luxor">
                            </div>
                            <div class="swiper-slide">
                            ...
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img6.png" alt="Red Sea snorkeling adventure">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img7.png" alt="Camel ride in the desert">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4">
                    ...
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img1.jpg" alt="Spring in Egypt - Blooming Nile views">
                            </div>
                            <div class="travel-season-content">
                                <h5>Spring (March–May)</h5>
                                <span>Weather: 20–35°C / 68–95°F (warmer in south)</span>
                                <div class="highlights-area">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Pleasant weather for Nile cruises & temples.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                        ...
                                        <li>
                                            ...
                                            Ideal for Red Sea diving & beach time.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Balanced weather, fewer crowds, families</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img2.jpg" alt="Summer in Egypt - Red Sea beaches">
                            </div>
                            <div class="travel-season-content">
                                <h5>Summer (June–August)</h5>
                                <span>Weather: 35–45°C+ / 95–113°F+ (very hot & dry)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            Excellent for Red Sea diving & resorts.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Early morning temple visits to beat the heat.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Budget travelers, beach lovers, heat-tolerant adventurers</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img3.jpg" alt="Autumn in Egypt - Mild Nile days">
                            </div>
                            <div class="travel-season-content">
                                <h5>Autumn (Sep–Nov)</h5>
                                <span>Weather: 25–35°C / 77–95°F (cooling down)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Comfortable sightseeing & Nile cruises.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Shoulder season — good deals & mild crowds.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Perfect for desert adventures & photography.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Most travelers, photographers, value seekers</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img4.jpg" alt="Winter in Egypt - Clear skies at pyramids">
                            </div>
                            <div class="travel-season-content">
                                <h5>Winter (Dec–Feb)</h5>
                                <span>Weather: 15–25°C / 59–77°F (mild & pleasant)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Ideal comfortable temps for all sites.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Peak season — vibrant atmosphere & events.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Clear skies & perfect pyramid photos.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: First-timers, history lovers, comfortable exploration</span>
                    </div>
                </div>
            </div>
        </div>
