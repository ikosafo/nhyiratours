        ...
        <div class="swiper destination-details-gallery-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="assets/img/innerpages/destination-details-gallery-img1.jpg" alt="">
                </div>
                <div class="swiper-slide">
                    <img src="assets/img/innerpages/destination-details-gallery-img2.jpg" alt="">
                </div>
                <div class="swiper-slide">
                    <img src="assets/img/innerpages/destination-details-gallery-img3.jpg" alt="">
                </div>
                <div class="swiper-slide">
                    <img src="assets/img/innerpages/destination-details-gallery-img4.jpg" alt="">
                </div>
                <div class="swiper-slide">
                    <img src="assets/img/innerpages/destination-details-gallery-img5.jpg" alt="">
                </div>
            </div>
        </div>
                        ...
                        <ul class="destination-info">
                            ...
                            <li>
                                ...
                                <div class="info">
                                    ...
                                    <div class="tooltip-text">English is commonly used by specialized guides; Italian and French may be spoken in some areas.</div>
                                </div>
                            </li>
                        </ul>
                        <p>Libya is home to some of the most magnificent and least-visited Roman ruins in the world, vast Sahara desert landscapes, and extraordinary prehistoric rock art. The UNESCO World Heritage sites of Leptis Magna and Sabratha, the historic medina of Tripoli, the dramatic Tadrart Acacus mountains with thousands of ancient paintings, the surreal Ubari lakes and dunes, and the ancient oasis city of Ghadames offer unparalleled experiences for serious archaeology enthusiasts and desert adventurers. However, due to ongoing security concerns and political instability, tourism in Libya remains **extremely limited** in 2026. Travel is only possible through highly specialized, licensed tour operators with government permits, private security arrangements, and restricted itineraries — primarily to the coastal Roman sites and select southern desert areas. Libya is currently a destination reserved for the most determined, well-prepared, and risk-tolerant travelers.</p>
                            ...
                            <div class="swiper-slide">
                                <div class="location-card">
                                    <div class="location-img">
                                        <img src="assets/img/innerpages/destination-dt-location-img1.jpg" alt="">
                                        ...
                                        <div class="image-album-wrap d-none">
                                            <!-- album links remain the same -->
                                        </div>
                                    </div>
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Leptis Magna – Roman City</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    <div class="location-img">
                                        <img src="assets/img/innerpages/destination-dt-location-img2.jpg" alt="">
                                    </div>
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Sabratha – Roman Theater</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    <div class="location-img">
                                        <img src="assets/img/innerpages/destination-dt-location-img3.jpg" alt="">
                                        <button class="img-album-btn">
                                            <!-- SVG -->
                                            3
                                        </button>
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Tripoli – Medina & Old City</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    <div class="location-img">
                                        <img src="assets/img/innerpages/destination-dt-location-img4.jpg" alt="">
                                    </div>
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Tadrart Acacus – Prehistoric Rock Art</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    <div class="location-img">
                                        <img src="assets/img/innerpages/destination-dt-location-img5.jpg" alt="">
                                    </div>
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Ubari Lakes & Sahara Dunes</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    <div class="location-img">
                                        <img src="assets/img/innerpages/destination-dt-location-img6.jpg" alt="">
                                        <button class="img-album-btn">
                                            <!-- SVG -->
                                            3
                                        </button>
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Ghadames – Ancient Oasis City</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    <div class="location-img">
                                        <img src="assets/img/innerpages/destination-dt-location-img7.jpg" alt="">
                                    </div>
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Jebel Nafusa – Berber Villages</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- slider buttons remain the same -->
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center">
                        ...
                        <p>Because we don’t just plan your trip — we craft safe, exclusive, and unforgettable journeys through one of the world’s most extraordinary yet least-visited destinations.</p>
                    </div>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        <svg width="55" height="55" viewBox="0 0 55 55" xmlns="http://www.w3.org/2000/svg">
                            <!-- same local expertise SVG -->
                        </svg>
                        <h4>Local Expertise</h4>
                        <p>Deep connections with Libya’s most experienced licensed guides, security experts, and local authorities — allowing safe, exclusive access to Leptis Magna, Acacus rock art, and remote desert regions.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        <svg width="55" height="55" viewBox="0 0 55 55" xmlns="http://www.w3.org/2000/svg">
                            <!-- same transparent pricing SVG -->
                        </svg>
                        <h4>Transparent Pricing</h4>
                        <p>No hidden costs — fully itemized, all-inclusive packages covering permits, private security, 4×4 transport, expert guides, and accommodation, with complete clarity.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        <svg width="55" height="55" viewBox="0 0 55 55" xmlns="http://www.w3.org/2000/svg">
                            <!-- same 24/7 support SVG -->
                        </svg>
                        <h4>24/7 Support</h4>
                        <p>Constant support from our dedicated Libya team and international coordination — handling permits, security updates, last-minute changes, and emergencies throughout your journey.</p>
                    </div>
                </div>
            </div>
            <ul>
                <li>Specialized Security & Permits</li>
                <li>Expert Archaeology & Desert Guides</li>
                <li>Exclusive, Low-Impact Experiences</li>
            </ul>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="swiper destionation-dt-customer-gallery-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img1.png" alt="Visitor admiring the grand Roman theater of Leptis Magna at sunset">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img2.png" alt="Exploring the remarkably preserved ruins of Leptis Magna">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img3.png" alt="Walking through the ancient Roman city of Sabratha">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img4.png" alt="Standing in the historic medina of Tripoli at dusk">
                            </div>
                            <div class="swiper-slide">
                            ...
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img6.png" alt="Marveling at thousands of prehistoric rock paintings in Tadrart Acacus">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img7.png" alt="Sunrise over the golden dunes and salt lakes near Ubari">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4">
                    ...
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img1.jpg" alt="Spring in Libya - Perfect clear weather over Leptis Magna">
                            </div>
                            <div class="travel-season-content">
                                <h5>Spring (March–May)</h5>
                                <span>Weather: 18–30°C / 64–86°F (mild & pleasant)</span>
                                <div class="highlights-area">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Ideal conditions for exploring Roman sites (Leptis Magna, Sabratha).
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Pleasant mornings for limited Sahara & Acacus expeditions.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Best overall season for photography of ruins & rock art.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Most visitors, archaeology & history lovers, comfortable weather</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img2.jpg" alt="Summer in Libya - Hot Mediterranean coast near Tripoli">
                            </div>
                            <div class="travel-season-content">
                                <h5>Summer (June–August)</h5>
                                <span>Weather: 30–45°C+ / 86–113°F+ (extremely hot & dry)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Early morning visits to coastal Roman sites (only for heat-tolerant travelers).
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Desert & southern sites practically inaccessible due to extreme heat.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Very few tourists at coastal sites (high-risk season).
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Only suitable for extremely heat-tolerant, experienced adventure travelers</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img3.jpg" alt="Autumn in Libya - Warm light over ancient Roman ruins">
                            </div>
                            <div class="travel-season-content">
                                <h5>Autumn (September–November)</h5>
                                <span>Weather: 22–35°C / 72–95°F (warm & comfortable)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Excellent conditions for Roman sites & permitted desert trips.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Fewer visitors & better shoulder-season conditions.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Perfect light for photography of ruins & rock art.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Archaeology enthusiasts, photographers, good conditions</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img4.jpg" alt="Winter in Libya - Mild & clear over Sabratha ruins">
                            </div>
                            <div class="travel-season-content">
                                <h5>Winter (December–February)</h5>
                                <span>Weather: 12–24°C / 54–75°F (mild & sunny)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Very comfortable for coastal Roman sites & Tripoli medina.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Clear skies & good conditions for permitted desert areas.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Lowest visitor numbers — most authentic & quiet experience.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Quiet exploration, archaeology lovers, mild winter conditions</span>
                    </div>
                </div>
            </div>
        </div>
