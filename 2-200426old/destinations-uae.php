                ...
                <div class="col-lg-10">
                    <div class="destination-details-content">
                        ...
                        <ul class="destination-info">
                            <li>
                                <div class="content">
                                    <span>Capital -</span> Abu Dhabi
                                </div>
                            </li>
                            <li>
                                <div class="content">
                                    <span>Currency -</span> UAE Dirham (AED)
                                </div>
                            ...
                            <li>
                                ...
                                <div class="info">
                                    ...
                                    <div class="tooltip-text">English is the dominant language in business, tourism, and daily life across the UAE.</div>
                                </div>
                            </li>
                        </ul>
                        <p>The United Arab Emirates is a dazzling fusion of ultra-modern innovation and timeless Arabian heritage. From the record-breaking skyscrapers and luxurious shopping malls of Dubai to the cultural grandeur of Abu Dhabi’s Sheikh Zayed Grand Mosque, futuristic attractions like the Louvre Abu Dhabi, and the vast golden dunes of the Liwa Desert, the UAE offers world-class experiences for every traveler. With pristine beaches, thrilling desert safaris, rich Emirati traditions, and exceptional hospitality, the UAE is the ultimate destination for luxury seekers, families, adventure enthusiasts, and those craving a perfect blend of futuristic glamour and cultural depth.</p>
                            ...
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Burj Khalifa & Dubai Downtown</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Sheikh Zayed Grand Mosque – Abu Dhabi</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Dubai Desert Safari & Dunes</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Palm Jumeirah & Atlantis</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Louvre Abu Dhabi</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Dubai Marina & Yacht Life</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Al Ain Oasis & Heritage</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center">
                        ...
                        <p>Because we don’t just plan your trip — we craft unforgettable, seamless journeys through the glamour and soul of the UAE.</p>
                    </div>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <p>Insider access to VIP experiences — from private Burj Khalifa views to exclusive desert camps, behind-the-scenes at Ferrari World, and hidden cultural gems across all seven emirates.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <p>No hidden fees — fully detailed, luxury packages including private transfers, VIP entry, desert adventures, and premium hotels, tailored to your budget and desires.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <h4>24/7 Support</h4>
                        <p>Round-the-clock assistance from our UAE team — handling last-minute bookings, private yacht charters, desert safaris, or any request, day or night.</p>
                    </div>
                </div>
            </div>
            <ul>
                <li>Personalized Luxury Itineraries</li>
                <li>VIP Access & Exclusive Experiences</li>
                <li>Trusted Local & International Partners</li>
            </ul>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="swiper destionation-dt-customer-gallery-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img1.png" alt="Visitor at the top of Burj Khalifa with Dubai skyline at night">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img2.png" alt="Sunset camel ride in the Dubai desert dunes">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img3.png" alt="Standing in awe inside the Sheikh Zayed Grand Mosque">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img4.png" alt="Luxury yacht cruise along Dubai Marina at sunset">
                            </div>
                            <div class="swiper-slide">
                            ...
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img6.png" alt="Exploring the futuristic Louvre Abu Dhabi galleries">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img7.png" alt="Private dune bashing & Bedouin camp experience">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4">
                    ...
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img1.jpg" alt="Spring in the UAE - Perfect weather in Dubai">
                            </div>
                            <div class="travel-season-content">
                                <h5>Spring (March–May)</h5>
                                <span>Weather: 25–35°C / 77–95°F (warm & pleasant)</span>
                                <div class="highlights-area">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Perfect weather for outdoor attractions & desert safaris.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Ideal for beaches, yacht trips & outdoor events.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Great for Expo events & outdoor festivals (when held).
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Most travelers, outdoor adventures, pleasant weather</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img2.jpg" alt="Summer in the UAE - Indoor luxury & beaches">
                            </div>
                            <div class="travel-season-content">
                                <h5>Summer (June–August)</h5>
                                <span>Weather: 35–45°C+ / 95–113°F+ (extremely hot outdoors)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Perfect for indoor attractions — malls, Ski Dubai, museums.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Great hotel deals & fewer outdoor crowds.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Indoor theme parks & waterparks at their best.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Indoor luxury, shopping, families, best hotel deals</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img3.jpg" alt="Autumn in the UAE - Mild weather & golden dunes">
                            </div>
                            <div class="travel-season-content">
                                <h5>Autumn (September–November)</h5>
                                <span>Weather: 28–38°C / 82–100°F (warm, cooling down)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Ideal for desert safaris & outdoor events.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Shoulder season — excellent hotel rates & fewer crowds.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Great for beaches, yachting & outdoor dining.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Beach lovers, desert adventures, excellent value</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img4.jpg" alt="Winter in the UAE - Perfect mild days in Dubai">
                            </div>
                            <div class="travel-season-content">
                                <h5>Winter (December–February)</h5>
                                <span>Weather: 20–28°C / 68–82°F (mild & sunny)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Perfect weather for all outdoor activities & desert camping.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Peak season — festivals, fireworks & Christmas markets.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Ideal for beaches, yachting & outdoor dining.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: First-timers, luxury seekers, festive atmosphere</span>
                    </div>
                </div>
            </div>
        </div>
