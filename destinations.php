<?php include ('./includes/header.php'); ?>
    ...
    <main>
        ...
        <section class="hero">
            ...
            <div class="bg-content container">
                <div class="hero-page-title">
                    <span class="hero-sub-title">Explore the World</span>
        ...
        <section class="p-top-90 p-bottom-90 bg-gray-gradient">
            <div class="container">
                <!-- Title -->
                <div class="d-xl-flex align-items-xl-center pb-4 aos-init aos-animate" data-aos="fade">
                    <div class="block-title me-auto">
                        <small class="sub-title">Explore our Top Destinations</small>
                    </div>
                </div>
                <!-- Title -->
                <!-- Destination list -->
                            ...
                            <div class="bottom-overlay-content">
                                <div class="destination-content">
                                    <div class="destination-info">
                                        <h3 class="destination-title">Netherlands</h3>
                                    </div>
                    ...
                    <div class="col-12 col-xxl-3 col-xl-4 col-md-6 aos-init aos-animate" data-aos="fade">
                        ...
                        <a href="#" class="destination bottom-overlay hover-effect rounded mb-4">
                            ...
                            <div class="bottom-overlay-content">
                                <div class="destination-content">
                                    <div class="destination-info">
                                        <h3 class="destination-title">Croatia</h3>
                                    </div>
                                    <span class="circle-icon circle-icon-link">
                                        <i class="hicon hicon-flights-pin"></i>
                                    </span>
                    ...
                    <div class="col-12 col-xxl-3 col-xl-4 col-md-6 aos-init aos-animate" data-aos="fade">
                        ...
                        <a href="#" class="destination bottom-overlay hover-effect rounded mb-4">
                            ...
                            <div class="bottom-overlay-content">
                                <div class="destination-content">
                                    <div class="destination-info">
                                        <h3 class="destination-title">Poland</h3>
                                    </div>
                                    <span class="circle-icon circle-icon-link">
                                        <i class="hicon hicon-flights-pin"></i>
                                    </span>
                    ...
                    <div class="col-12 col-xxl-3 col-xl-4 col-md-6 aos-init aos-animate" data-aos="fade">
                        ...
                        <a href="#" class="destination bottom-overlay hover-effect rounded mb-4">
                            ...
                            <div class="bottom-overlay-content">
                                <div class="destination-content">
                                    <div class="destination-info">
                                        <h3 class="destination-title">Denmark</h3>
                                    </div>
                                    <span class="circle-icon circle-icon-link">
                                        <i class="hicon hicon-flights-pin"></i>
                                    </span>
                    ...
                    <div class="col-12 col-xxl-3 col-xl-4 col-md-6 aos-init aos-animate" data-aos="fade">
                        ...
                        <a href="#" class="destination bottom-overlay hover-effect rounded mb-4">
                            ...
                            <div class="bottom-overlay-content">
                                <div class="destination-content">
                                    <div class="destination-info">
                                        <h3 class="destination-title">Switzerland</h3>
                                    </div>
                                    <span class="circle-icon circle-icon-link">
                                        <i class="hicon hicon-flights-pin"></i>
                                    </span>
