                ...
                <div class="col-lg-10">
                    <div class="destination-details-content">
                        ...
                        <ul class="destination-info">
                            <li>
                                <div class="content">
                                    <span>Capital -</span> Rabat
                                </div>
                            </li>
                            <li>
                                <div class="content">
                                    <span>Currency -</span> Moroccan Dirham (MAD)
                                </div>
                            ...
                            <li>
                                ...
                                <div class="info">
                                    ...
                                    <div class="tooltip-text">French and English are widely spoken in tourist areas.</div>
                                </div>
                            </li>
                        </ul>
                        <p>Morocco, known as the <span>"Kingdom of the West"</span>, enchants travelers with its vibrant blend of ancient medinas, majestic Atlas Mountains, golden Sahara dunes, and stunning Atlantic and Mediterranean coastlines. From the bustling souks of Marrakech to the blue-washed streets of Chefchaouen, imperial cities like Fes and Rabat, and luxurious riads, Morocco offers rich culture, exquisite cuisine, and warm hospitality. A crossroads of Arab, Berber, and European influences, Morocco is a dream destination for adventure seekers, food lovers, history enthusiasts, and those craving authentic experiences.</p>
                            ...
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Marrakech Medina</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Sahara Desert</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Chefchaouen</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Fes Medina</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Atlas Mountains</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Essaouira Coast</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    ...
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Ait Ben Haddou</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center">
                        ...
                        <p>Because we don’t just plan your trip — we craft unforgettable journeys through the Kingdom of Morocco.</p>
                    </div>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <p>From hidden riads in Marrakech to private desert camps under the stars — we curate every journey with insider knowledge from local Moroccan guides.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <p>No hidden fees — clear, all-inclusive packages for riad stays, private drivers, and authentic experiences, tailored to your budget.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <h4>24/7 Support</h4>
                        <p>Round-the-clock assistance from our local team — whether it's riad upgrades, camel trek bookings, or any adventure in the medinas or desert.</p>
                    </div>
                </div>
            </div>
            <ul>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="swiper destionation-dt-customer-gallery-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img1.png" alt="Customer in Marrakech Jemaa el-Fna square">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img2.png" alt="Sunset camel ride in the Sahara">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img3.png" alt="Exploring the blue streets of Chefchaouen">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img4.png" alt="Rooftop dinner in a Fes riad">
                            </div>
                            <div class="swiper-slide">
                            ...
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img6.png" alt="Surfing on the Atlantic coast near Essaouira">
                            </div>
                            <div class="swiper-slide">
                                <img src="assets/img/innerpages/customer-gallery-img7.png" alt="Hiking in the Atlas Mountains">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-4">
                    ...
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img1.jpg" alt="Spring in Morocco - Blooming gardens in Marrakech">
                            </div>
                            <div class="travel-season-content">
                                <h5>Spring (March–May)</h5>
                                <span>Weather: 15–28°C / 59–82°F (pleasant & mild)</span>
                                <div class="highlights-area">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Perfect weather for medinas & desert trips.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Blooming roses in the Valley of the Roses.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Ideal for hiking in the Atlas Mountains.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: First-timers, photographers, comfortable exploration</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img2.jpg" alt="Summer in Morocco - Atlantic coast breeze">
                            </div>
                            <div class="travel-season-content">
                                <h5>Summer (June–August)</h5>
                                <span>Weather: 25–40°C / 77–104°F (hot inland, cooler on coast)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Cooler coastal escapes in Essaouira & Agadir.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Fewer crowds in the mountains & coast.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Great for beach holidays & water sports.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Beach lovers, budget travelers, coastal escapes</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img3.jpg" alt="Autumn in Morocco - Golden Sahara dunes">
                            </div>
                            <div class="travel-season-content">
                                <h5>Autumn (September–November)</h5>
                                <span>Weather: 18–30°C / 64–86°F (warm & comfortable)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Ideal for desert camping & Marrakech exploration.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Shoulder season — fewer crowds & good prices.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Harvest festivals & argan oil season.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Most travelers, food lovers, value seekers</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="assets/img/innerpages/travel-season-img4.jpg" alt="Winter in Morocco - Snow-capped Atlas Mountains">
                            </div>
                            <div class="travel-season-content">
                                <h5>Winter (December–February)</h5>
                                <span>Weather: 10–22°C / 50–72°F (mild, cooler in mountains)</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Pleasant days for city exploration & souks.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Snow in the High Atlas — skiing & mountain views.
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Peak season in cities — vibrant & festive.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Perfect For: Culture seekers, mountain lovers, festive atmosphere</span>
                    </div>
                </div>
            </div>
        </div>
